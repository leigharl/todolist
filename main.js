window.addEventListener('load', () => {
    ...
    const createTaskElement = (task, completed) => {
        ...
        tasks_edit_el.innerHTML = completed ? '<i class="ri-save-line"></i>' : '<i class="ri-pencil-line">edit</i>';
        ...
        tasks_delete_el.innerHTML = '<i class="ri-delete-back-2-line"></i>';
    ...
    const handleEdit = (tasks_el, tasks_input_el, tasks_edit_el) => {
        ...
        if (tasks_edit_el.innerText.toLowerCase() == "edit") {
            ...
            tasks_edit_el.innerHTML = '<i class="ri-save-line"></i>';

        } else {

            tasks_input_el.setAttribute("readonly", "readonly");

            tasks_edit_el.innerHTML = '<i class="ri-pencil-line">edit</i>';
